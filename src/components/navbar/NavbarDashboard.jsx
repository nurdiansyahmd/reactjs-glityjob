...
function NavbarDashboard() {
    ...
    return (
        <nav className="fixed z-10 top-0 right-0 left-[255px] bg-white p-2 sm:px-4 border-b border-gray-200 rounded dark:bg-gray-900">
                <div className="container flex flex-wrap items-center justify-between mx-auto"> 
                    ...
                    <ul className="flex gap-3 flex-row items-center flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            {!Cookies.get('token') && <li><Link to={'/login'} className="font-semibold">MASUK</Link></li>}
                            {Cookies.get('token') && 
                            <li>
                                <Dropdown
                                label={
                                ...
                                <Dropdown.Item>
                                    <Link to={'/dashboard/change-password'}>Setting</Link>
                                </Dropdown.Item>
